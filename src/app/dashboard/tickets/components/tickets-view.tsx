  ...
  return (
    <div className="flex-1 space-y-4 p-8 pt-6">
      ...
      <Tabs defaultValue="allDepartments">
        <TabsList className="grid w-2/5 grid-cols-5">
          ...
          <TabsTrigger value="maintenance">Maintaince</TabsTrigger>
        </TabsList>
        ...
        <TabContent value="maintaince" tickets={tickets.filter((ticket)=>ticket.type==="Maintaince")} />
      </Tabs>
    </div>
  );
}
